...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='models/fixed256/hrnet18_idih.py',
                        help='Path to the model script.')

    parser.add_argument('--exp-name', type=str, default='first-try',
                        help='Here you can specify the name of the experiment. '
                             'It will be added as a suffix to the experiment folder.')
    parser.add_argument('--workers', type=int, default=0,
                        metavar='N', help='Dataloader threads.')

    parser.add_argument('--batch-size', type=int, default=8,#-1
    ...
    parser.add_argument('--gpus', type=str, default='1', required=False,
