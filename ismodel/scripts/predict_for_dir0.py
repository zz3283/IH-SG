...
def main():
    ...
    for image_name in tqdm(image_names):
        ...
        gtpath = args.gt
        gt_path = osp.join(gtpath, image_name)
...
def parse_args():
    ...
    parser.add_argument(
        '--gt', type=str,
        help='Path to directory with .jpg for real images,'
    )
    parser.add_argument(
